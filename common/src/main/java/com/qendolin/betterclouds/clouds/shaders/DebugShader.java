...
public class DebugShader extends Shader {
    ...
    public static final Identifier VERTEX_SHADER_ID = Identifier.fromNamespaceAndPath(BetterCloudsStatic.MODID, "shaders/core/debug.vsh");
    public static final Identifier FRAGMENT_SHADER_ID = Identifier.fromNamespaceAndPath(BetterCloudsStatic.MODID, "shaders/core/debug.fsh");
