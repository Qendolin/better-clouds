...
public class CoverageShader extends Shader {
    ...
    public static final String DEF_IRIS = "_IRIS_";
    public static final String DEF_WORLD_CURVATURE = "_WORLD_CURVATURE_";

    public static final Identifier VERTEX_SHADER_ID = Identifier.fromNamespaceAndPath(BetterCloudsStatic.MODID, "shaders/opengl/betterclouds_coverage.vsh");
    public static final Identifier FRAGMENT_SHADER_ID = Identifier.fromNamespaceAndPath(BetterCloudsStatic.MODID, "shaders/opengl/betterclouds_coverage.fsh");
    ...
    public static CoverageShader create(ResourceManager manager, float sizeXZ, float sizeY, boolean stencilFallback, boolean dhCompat, boolean irisCompat, int worldCurvatureSize) throws IOException {
        Map<String, String> defs = ImmutableMap.ofEntries(
                ...
                Map.entry(CoverageShader.DEF_IRIS, irisCompat ? "1" : "0"),
