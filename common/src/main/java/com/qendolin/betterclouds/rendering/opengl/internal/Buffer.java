package com.qendolin.betterclouds.rendering.opengl.internal;
...
public class Buffer implements AutoCloseable {
    ...
    public Buffer(int size, boolean fancy, boolean preferPersistent) {
        boolean usePersistent = preferPersistent && (instance.arbBufferStorage || instance.openGl44);
        this.size = size;
        this.fancy = fancy;

        vaoId = glGenVertexArrays();
        glBindVertexArray(vaoId);
        instance.objectLabelDev(instance.GL_VERTEX_ARRAY, vaoId, "clouds_buffer");
        ...
        instance.objectLabelDev(instance.GL_BUFFER, meshId, "cloud_mesh");
        ...
        instance.vertexAttribDivisor(0, 1);
    ...
    private void allocatePersistent(long vboSize) {
        int flags = GL_MAP_WRITE_BIT | instance.GL_MAP_PERSISTENT_BIT | instance.GL_MAP_COHERENT_BIT;
        glBindBuffer(GL_ARRAY_BUFFER, writeBufferId);
        instance.bufferStorage(GL_ARRAY_BUFFER, vboSize, flags);
        ...
        instance.objectLabelDev(instance.GL_BUFFER, writeBufferId, "cloud_positions_a");
        ...
        instance.objectLabelDev(instance.GL_BUFFER, drawBufferId, "cloud_positions_b");
    }

    private void allocateMutable(long vboSize) {
        writeBuffer = MemoryUtil.memAllocFloat((int) (vboSize / Float.BYTES));
        instance.objectLabelDev(instance.GL_BUFFER, writeBufferId, "cloud_positions");
    ...
    public boolean hasChanged(int size, boolean fancy, boolean persistent) {
        return size != this.size || fancy != this.fancy || ((instance.arbBufferStorage || instance.openGl44) && persistent) != this.usePersistent;
    }
