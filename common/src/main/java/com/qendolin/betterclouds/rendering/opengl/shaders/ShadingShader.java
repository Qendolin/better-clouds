...
public class ShadingShader extends Shader {
    public static final Identifier VERTEX_SHADER_ID = Identifier.fromNamespaceAndPath(BetterCloudsStatic.MODID, "shaders/opengl/betterclouds_shading.vsh");
    public static final Identifier FRAGMENT_SHADER_ID = Identifier.fromNamespaceAndPath(BetterCloudsStatic.MODID, "shaders/opengl/betterclouds_shading.fsh");
